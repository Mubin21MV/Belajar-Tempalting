    ...
    <div class="product-grid">
        ...
        <div class="card">
            <div class="card-img">
                ...
                <img src="{{ asset('images/kaos-ungu.jpeg') }}" alt="Purple T-Shirt">
            </div>
            <div class="card-body">
        ...
        <div class="card">
            <div class="card-img">
                ...
                <img src="{{ asset('images/jaket-bomber.jpeg') }}" alt="Bomber Jacket">
            </div>
            <div class="card-body">
        ...
        <div class="card">
            <div class="card-img">
                ...
                <img src="{{ asset('images/parka.jpeg') }}" alt="Reversible Parka">
            </div>
            <div class="card-body">
        ...
        <div class="card">
            <div class="card-img">
                ...
                <img src="{{ asset('images/rompi.jpeg') }}" alt="Premium Vest">
            </div>
            <div class="card-body">
        ...
        <div class="card">
            <div class="card-img">
                ...
                <img src="{{ asset('images/jersey.jpeg') }}" alt="Nama Produk">
            </div>
            <div class="card-body">
        ...
        <div class="card">
            <div class="card-img">
                ...
                <img src="{{ asset('images/pdh-clean&profesional.jpeg') }}" alt="Nama Produk">
            </div>
            <div class="card-body">
        ...
        <div class="card">
            <div class="card-img">
                ...
                <img src="{{ asset('images/t-shirt-white.jpeg') }}" alt="Nama Produk">
            </div>
            <div class="card-body">
                <p class="category">T-Shirt</p>
        ...
        <div class="card">
            <div class="card-img">
                ...
                <img src="{{ asset('images/t-shirt-navyblue.jpeg') }}" alt="Nama Produk">
            </div>
            <div class="card-body">
                <p class="category">T-Shirt</p>
